<template>
    <div class="notification flex items-center justify-between bg-green-100 hover:bg-teal-100 cursor-pointer">
        <div class="px-4 py-6">
        ...
        <div>
            <svg class="mr-4 invisible" width="18" height="18" viewBox="0 0 18 18" xmlns="http://www.w3.org/2000/svg"><path d="M14.25 3.75l-6.297 10.5-4.203-4.2" stroke-width="1.5" stroke="currentColor" fill="none" fill-rule="evenodd" stroke-linecap="round" stroke-linejoin="round"></path></svg>
        </div>
    </div>
</template>
